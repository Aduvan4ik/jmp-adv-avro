package com.jmp.avro.v1.consumer;
...
public class KafkaConsumerV1 {
    ...
    private static final Logger logger = LoggerFactory.getLogger(KafkaConsumerV1.class);

    public void consume(String topic) {
        Properties properties = new Properties();
        // normal consumer
        properties.setProperty("bootstrap.servers", "127.0.0.1:9092");
        properties.put("group.id", "book-consumer-group-v1");
        ...
        try (KafkaConsumer<String, Book> kafkaConsumer = new KafkaConsumer<>(properties)) {
            ...
            logger.info("Kafka consumer v1 is reading ...");
