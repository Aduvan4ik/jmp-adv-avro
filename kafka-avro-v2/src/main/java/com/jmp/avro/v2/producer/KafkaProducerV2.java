package com.jmp.avro.v2.producer;
...
public class KafkaProducerV2 {
    ...
    private static final Logger logger = LoggerFactory.getLogger(KafkaProducerV2.class);
